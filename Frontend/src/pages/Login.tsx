            ...
            <div className="w-full max-w-[420px] relative z-10 mx-auto transition-all duration-300 ease-in-out">
                <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-gray-800 shadow-2xl rounded-3xl p-8 space-y-8 text-center">
                    ...
                    <div className="space-y-3">
                        <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg transform hover:scale-105 transition-transform duration-300">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Secure AI-Powered Financial Auditing
                        </p>
                    </div>
                        ...
                        <div className="space-y-5">
                            <div className="space-y-2 flex flex-col items-center">
                                ...
                                <Input
                                    id="email"
                                    type="email"
                                    className="px-4 h-12 bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-500 focus:ring-blue-500/20 rounded-xl transition-all text-center"
                                    required
                                    value={email}
                            ...
                            <div className="space-y-2 flex flex-col items-center">
                                ...
                                />
                                <a href="#" className="text-xs text-blue-600 hover:text-blue-500 font-medium transition-colors mt-1">Forgot password?</a>
                            </div>
                        </div>

                        <Button
                            type="submit"
                            className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-500/20 rounded-xl font-medium transition-all transform hover:-translate-y-0.5 mt-4"
                            disabled={loading}
                        >
                            {loading ? (
