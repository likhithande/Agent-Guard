            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-gray-800 shadow-2xl rounded-3xl p-8 space-y-8">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between ml-1">
                                    ...
                                    <a href="#" className="text-xs text-blue-600 hover:text-blue-500 font-medium transition-colors">Forgot password?</a>
                                </div>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <Button
                            type="submit"
                            className="w-full h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-500/20 rounded-xl font-medium transition-all transform hover:-translate-y-0.5"
                            disabled={loading}
                        >
                            {loading ? (
                    ...
                    <Button
                        variant="outline"
                        type="button"
                        className="w-full h-11 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl font-medium text-gray-700 dark:text-gray-200 transition-all"
